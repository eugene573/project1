          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="card card-primary card-outline">
                ...
                <br>
                <br>
                <center><button type="submit" class="btn btn-success" style="border-radius: 4px; text-color: black;">Upload</button></center>
                  </form>
                </div>
                <!-- /.card-body -->
              </div>
                  ...
                  <div class="tab-content">
                      ...
                      <form class="form-horizontal" method="POST" action="{{ route('adminUpdateInfo') }}" id="AdminInfoForm">
                        ...
                        <div class="form-group row">
                          <div class="offset-sm-2 col-sm-10">
                            <button type="submit" class="btn btn-danger" style="border-radius: 4px; text-color: black;">Save Changes</button>
                          </div>
                        </div>
                      </form>
                    </div>
                    ...
                    <div class="tab-pane" id="change_password">
                        <form class="form-horizontal" action="{{ route('adminChangePassword') }}" method="POST" id="changePasswordAdminForm">
                          ...
                          <div class="form-group row">
                            <div class="offset-sm-2 col-sm-10">
                              <button type="submit" class="btn btn-danger" style="border-radius: 4px; text-color: black;">Update Password</button>
                            </div>
                          </div>
                        </form>
                      </div>
